...
int main()
{
	...
	//DES STRUCTURE
	string plaintext; vector<int> PlainText; int round_in[64] = { 0 };
	...
	{
		if (!(plaintext[i] > 47 && plaintext[i] < 58) && !(plaintext[i] > 64 && plaintext[i] < 71))
		{
			cout << "ERROR input " << plaintext[i] << endl;
			exit(EXIT_FAILURE);
		}
	}
	for (int i = 0; i < plaintext.length(); i++)
	{
		switch (plaintext[i])
		{
		case '0':{PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(0); break; }
		case '1':{PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(1); break; }
		case '2':{PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(0); break; }
		case '3':{PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(1); break; }
		case '4':{PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(0); break; }
		case '5':{PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(1); break; }
		case '6':{PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(0); break; }
		case '7':{PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(1); break; }
		case '8':{PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(0); break; }
		case '9':{PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(0); PlainText.push_back(1); break; }
		case 'A':{PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(0); break; }
		case 'B':{PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(1); PlainText.push_back(1); break; }
		case 'C':{PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(0); break; }
		case 'D':{PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(0); PlainText.push_back(1); break; }
		case 'E':{PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(0); break; }
		case 'F':{PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(1); PlainText.push_back(1); break; }

		}
	}

    //Run Encryption N Times
	int N;
	cin >> N;
	if (N<0 || N>1000)
	{
	...
	for (int t = 0; t < N; t++)
	{
		//Initial Permutation
		for (int i = 0; i < 64; i++)
			round_in[i] = PlainText[init_p[i] - 1];
	...
	if (N == 0)
	{
		...
		{
			cout << hex << uppercase << (PlainText[i] * 8 + PlainText[i + 1] * 4 + PlainText[i + 2] * 2 + PlainText[i + 3]);
		}
		cout << endl;
	}
	else
